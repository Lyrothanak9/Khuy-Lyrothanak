    ...
    <header className="sticky top-0 z-50 border-b border-slate-300 dark:border-slate-600 transition-none bg-background-light dark:bg-[#0f172a]">
      <div className="max-w-6xl mx-auto flex justify-between items-center h-16 px-4">
        ...
        <div className="flex items-center gap-2">
          <HiCommandLine className="text-2xl text-[#00174B] dark:text-white" />
          <span className="text-lg sm:text-2xl font-bold tracking-tight text-[#00174B] dark:text-white">
            Khuy Lyrothanak
          </span>
        </div>
        ...
        <nav className="hidden md:flex gap-6 font-bold dark:text-slate-200">
          <a
            href="#home"
            className="px-4 py-2 rounded-full text-[#00174B] hover:bg-slate-200 dark:text-white dark:hover:bg-slate-700 transition duration-300"
          >
            Home
          </a>
          <a
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <span className="flex items-center gap-1 dark:hidden">
              <span className="material-symbols-outlined text-lg text-[#00174B] font-bold">
                <MdDarkMode />
              </span>
              <span className="hidden sm:inline text-sm font-bold text-[#00174B]">Dark</span>
            </span>
          ...
          <button
            onClick={toggleMenu}
            className="md:hidden flex items-center justify-center w-10 h-10 rounded-lg border border-slate-300 dark:border-slate-600 text-[#00174B] dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition duration-300"
          >
        ...
        <div className="md:hidden border-t border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900">
          <nav className="flex flex-col px-4 py-4 gap-2">
            <a
              ...
              className="px-4 py-2 rounded-lg text-[#00174B] hover:bg-slate-200 dark:text-white dark:hover:bg-slate-700 transition duration-300"
            >
              Home
            </a>
            <a
